...
export const meta = mergeMeta<typeof loader>(({ data, params }) => {
  ...
  return [
    { title: `Bisanonton - Search results for ${params.movieKeyword}` },
    {
      name: 'keywords',
    ...
    {
      property: 'og:url',
      content: `${process.env.BASE_URL}/search/movie/${params.movieKeyword}`,
    },
    { property: 'og:title', content: `Bisanonton - Search results for ${params.movieKeyword}` },
    {
      property: 'og:image',
    ...
    { name: 'twitter:title', content: `Bisanonton - Search results for ${params.movieKeyword}` },
  ];
});
