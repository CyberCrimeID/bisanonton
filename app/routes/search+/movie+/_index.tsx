...
export const meta = mergeMeta(() => [
  { title: 'Bisanonton - Search Movies' },
  { name: 'description', content: 'Search Movies on Bisanonton' },
  {
    property: 'og:url',
    content: `${process.env.BASE_URL}/search/movie/ `,
  },
  { property: 'og:title', content: 'Bisanonton - Search Movies' },
  { property: 'og:description', content: 'Search Movies on Bisanonton' },
  { name: 'twitter:title', content: 'Bisanonton - Search Movies' },
  { name: 'twitter:description', content: 'Search Movies on Bisanonton' },
]);
