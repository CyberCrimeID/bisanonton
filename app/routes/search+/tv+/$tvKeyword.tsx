...
export const meta = mergeMeta(({ data, params }) => {
  ...
  return [
    { title: `Bisanonton - Search results for ${params.tvKeyword}` },
    {
      name: 'keywords',
    ...
    { property: 'og:url', content: `${process.env.BASE_URL}/search/tv/${params.tvKeyword}` },
    { property: 'og:title', content: `Bisanonton - Search results for ${params.tvKeyword}` },
    {
      property: 'og:image',
    ...
    { name: 'twitter:title', content: `Bisanonton - Search results for ${params.tvKeyword}` },
  ];
});
