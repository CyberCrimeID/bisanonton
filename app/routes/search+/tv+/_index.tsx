...
export const meta = mergeMeta(() => [
  { title: 'Bisanonton - Search Tv Shows' },
  { name: 'description', content: 'Search Tv Shows on Bisanonton' },
  { property: 'og:url', content: `${process.env.BASE_URL}/search/tv/` },
  { property: 'og:title', content: 'Bisanonton - Search Tv Shows' },
  { property: 'og:description', content: 'Search Tv Shows on Bisanonton' },
  { name: 'twitter:title', content: 'Bisanonton - Search Tv Shows' },
  { name: 'twitter:description', content: 'Search Tv Shows on Bisanonton' },
]);
