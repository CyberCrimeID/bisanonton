...
export const meta = mergeMeta<typeof loader>(({ data, params }) => {
  ...
  return [
    { title: `Bisanonton - Search results for ${params.peopleKeyword}` },
    {
      name: 'keywords',
    ...
    {
      property: 'og:url',
      content: `${process.env.BASE_URL}/search/people/${params.peopleKeyword}`,
    },
    { property: 'og:title', content: `Bisanonton - Search results for ${params.peopleKeyword}` },
    {
      property: 'og:image',
    ...
    { name: 'twitter:title', content: `Bisanonton - Search results for ${params.peopleKeyword}` },
  ];
});
