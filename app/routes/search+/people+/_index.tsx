...
export const meta = mergeMeta(() => [
  { title: 'Bisanonton - Search People' },
  { name: 'description', content: 'Search People on Bisanonton' },
  { property: 'og:url', content: `${process.env.BASE_URL}/search/people/` },
  { property: 'og:title', content: 'Bisanonton - Search People' },
  { property: 'og:description', content: 'Search People on Bisanonton' },
  { name: 'twitter:title', content: 'Bisanonton - Search People' },
  { name: 'twitter:description', content: 'Search People on Bisanonton' },
]);
