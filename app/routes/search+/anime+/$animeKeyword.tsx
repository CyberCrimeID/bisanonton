...
export const meta = mergeMeta<typeof loader>(({ data, params }) => {
  ...
  return [
    { title: `Bisanonton - Search results for ${params.animeKeyword}` },
    {
      name: 'keywords',
    ...
    {
      property: 'og:url',
      content: `${process.env.BASE_URL}/search/anime/${params.animeKeyword}`,
    },
    { property: 'og:title', content: `Bisanonton - Search results for ${params.animeKeyword}` },
    {
      property: 'og:image',
    ...
    { name: 'twitter:title', content: `Bisanonton - Search results for ${params.animeKeyword}` },
  ];
});
