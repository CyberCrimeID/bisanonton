...
export const meta = mergeMeta(() => [
  { title: 'Bisanonton - Search Anime' },
  { name: 'description', content: 'Search Anime on Bisanonton' },
  { property: 'og:url', content: `${process.env.BASE_URL}/search/anime/` },
  { property: 'og:title', content: 'Bisanonton - Search Anime' },
  { property: 'og:description', content: 'Search Anime on Bisanonton' },
  { name: 'twitter:title', content: 'Bisanonton - Search Anime' },
  { name: 'twitter:description', content: 'Search Anime on Bisanonton' },
]);
