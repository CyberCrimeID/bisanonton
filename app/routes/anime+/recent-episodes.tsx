...
export const meta = mergeMeta(() => [
  { title: 'Bisanonton - Recent Anime Episodes' },
  { name: 'description', content: 'Recent Anime Episodes' },
  { property: 'og:url', content: `${process.env.BASE_URL}/anime/recent-episodes` },
  { property: 'og:title', content: 'Bisanonton - Recent Anime Episodes' },
  { property: 'og:description', content: 'Recent Anime Episodes' },
  { name: 'twitter:title', content: 'Bisanonton - Recent Anime Episodes' },
