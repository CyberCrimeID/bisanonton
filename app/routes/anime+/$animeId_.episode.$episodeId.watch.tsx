...
export const meta = mergeMeta<typeof loader>(({ data, params }) => {
  ...
  return [
    { title: `Bisanonton - Watch ${animeTitle} episode ${episodeInfo?.number || ''}` },
    {
      name: 'description',
      content: description
    ...
    {
      property: 'og:url',
      content: `${process.env.BASE_URL}/anime/${params.animeId}/episode/${params.episodeId}/watch`,
    },
    {
      property: 'og:title',

      content: `Bisanonton - Watch ${animeTitle} episode ${episodeInfo?.number || ''}`,
    },
    {
