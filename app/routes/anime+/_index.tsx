...
export const meta = mergeMeta(() => [
  { title: 'Bisanonton - Anime' },
  { name: 'description', content: 'Discover anime in Bisanonton' },
  { property: 'og:url', content: `${process.env.BASE_URL}/anime` },
  { property: 'og:title', content: 'Bisanonton - Anime' },
  { property: 'og:description', content: 'Discover anime in Bisanonton' },
  { name: 'twitter:title', content: 'Bisanonton - Anime' },
  { name: 'twitter:description', content: 'Discover anime in Bisanonton' },
]);
