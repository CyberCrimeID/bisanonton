...
export const meta = mergeMeta(() => [
  { title: 'Bisanonton - Popular Anime' },
  { name: 'description', content: 'Popular Anime' },
  { property: 'og:url', content: `${process.env.BASE_URL}/anime/popular` },
  { property: 'og:title', content: 'Bisanonton - Popular Anime' },
  { property: 'og:description', content: 'Popular Anime' },
  { name: 'twitter:title', content: 'Bisanonton - Popular Anime' },
