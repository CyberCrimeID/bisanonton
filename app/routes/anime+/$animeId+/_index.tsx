...
export const meta = mergeMeta<{}, { 'routes/anime+/$animeId': typeof animeIdLoader }>(
  ({ params, matches }) => {
    ...
    return [
      ...
      { property: 'og:url', content: `${process.env.BASE_URL}/anime/${params.animeId}` },
      { property: 'og:title', content: `Bisanonton - ${animeTitle}` },
      {
      ...
      { name: 'twitter:title', content: `Bisanonton - ${animeTitle}` },
      {
