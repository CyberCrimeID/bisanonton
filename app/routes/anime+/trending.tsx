...
export const meta = mergeMeta(() => [
  { title: 'Bisanonton - Trending Anime' },
  { name: 'description', content: 'Trending Anime' },
  { property: 'og:url', content: `${process.env.BASE_URL}/anime/trending` },
  { property: 'og:title', content: 'Bisanonton - Trending Anime' },
  { property: 'og:description', content: 'Trending Anime' },
  { name: 'twitter:title', content: 'Bisanonton - Trending Anime' },
