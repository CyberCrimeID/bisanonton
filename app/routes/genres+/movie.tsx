...
export const meta = mergeMeta(() => [
  { title: 'Bisanonton Movies - Genres' },
  { name: 'description', content: 'Movies Genres' },
  { property: 'og:url', content: `${process.env.BASE_URL}/genres/movies` },
  { property: 'og:title', content: 'Bisanonton Movies - Genres' },
  { property: 'og:image', content: `${process.env.BASE_URL}/api/ogimage?it=movies` },
  { property: 'og:description', content: 'Movies Genres' },
  { name: 'twitter:title', content: 'Bisanonton Movies - Genres' },
