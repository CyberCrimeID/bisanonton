...
export const meta = mergeMeta(() => [
  { title: 'Bisanonton Tv shows - Genres' },
  { name: 'description', content: 'Tv shows Genres' },
  { property: 'og:url', content: `${process.env.BASE_URL}/genres/tv` },
  { property: 'og:title', content: 'Bisanonton Tv shows - Genres' },
  { property: 'og:image', content: `${process.env.BASE_URL}/api/ogimage?it=tvshows` },
  { property: 'og:description', content: 'Tv shows Genres' },
  { name: 'twitter:title', content: 'Bisanonton Tv shows - Genres' },
