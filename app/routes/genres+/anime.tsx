...
export const meta = mergeMeta(() => [
  { title: 'Bisanonton Anime - Genres' },
  { name: 'description', content: 'Anime Genres' },
  { property: 'og:url', content: `${process.env.BASE_URL}/genres/anime` },
  { property: 'og:title', content: 'Bisanonton Anime - Genres' },
  { property: 'og:image', content: `${process.env.BASE_URL}/api/ogimage?it=anime` },
  { property: 'og:description', content: 'Anime Genres' },
  { name: 'twitter:title', content: 'Bisanonton Anime - Genres' },
