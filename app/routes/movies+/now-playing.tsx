...
export const meta = mergeMeta(() => [
  { title: 'Bisanonton - Now Playing Movies' },
  { name: 'description', content: 'Now Playing Movies' },
  { property: 'og:url', content: `${process.env.BASE_URL}/movies/now-playing` },
  { property: 'og:title', content: 'Bisanonton - Now Playing Movies' },
  { property: 'og:description', content: 'Now Playing Movies' },
  { name: 'twitter:title', content: 'Bisanonton - Now Playing Movies' },
