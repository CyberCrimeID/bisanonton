...
export const meta = mergeMeta<typeof loader>(({ data, params }) => {
  ...
  return [
    { title: `Bisanonton - Watch ${movieTitle}` },
    ...
    { property: 'og:url', content: `${process.env.BASE_URL}/movies/${params.movieId}/watch` },
    { property: 'og:title', content: `Bisanonton - Watch ${movieTitle}` },
    { property: 'og:description', content: overview },
    {
      property: 'og:image',
      content: `${process.env.BASE_URL}/api/ogimage?m=${params.movieId}&mt=movie`,
    },
    { name: 'twitter:title', content: `Bisanonton - Watch ${movieTitle}` },
