...
export const meta = mergeMeta(() => [
  { title: 'Bisanonton - Movies' },
  { name: 'description', content: 'Discover movies in Bisanonton' },
  { property: 'og:url', content: `${process.env.BASE_URL}/movies/` },
  { property: 'og:title', content: 'Bisanonton - Movies' },
  { property: 'og:description', content: 'Discover movies in Bisanonton' },
  { name: 'twitter:title', content: 'Bisanonton - Movies' },
  { name: 'twitter:description', content: 'Discover movies in Bisanonton' },
]);
