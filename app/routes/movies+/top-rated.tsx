...
export const meta = mergeMeta(() => [
  { title: 'Bisanonton - Top Rated Movies' },
  { name: 'description', content: 'Top Rated Movies' },
  { property: 'og:url', content: `${process.env.BASE_URL}/movies/top-rated` },
  { property: 'og:title', content: 'Bisanonton - Top Rated Movies' },
  { property: 'og:description', content: 'Top Rated Movies' },
  { name: 'twitter:title', content: 'Bisanonton - Top Rated Movies' },
