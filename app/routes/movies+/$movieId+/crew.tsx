...
export const meta = mergeMeta<typeof loader, { 'routes/movies+/$movieId': typeof movieIdLoader }>(
  ({ params, matches }) => {
    ...
    return [
      { title: `Bisanonton - ${movieTitle} - Crew` },
      {
        property: 'og:url',
        content: `${process.env.BASE_URL}/movies/${params.movieId}/crew`,
      },
      { property: 'og:title', content: `Bisanonton - ${movieTitle} - Crew` },
      { name: 'twitter:title', content: `Bisanonton - ${movieTitle} - Crew` },
    ];
  },
);
