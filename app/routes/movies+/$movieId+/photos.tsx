...
export const meta = mergeMeta<typeof loader, { 'routes/movies+/$movieId': typeof movieIdLoader }>(
  ({ params, matches }) => {
    ...
    return [
      { title: `Bisanonton - ${movieTitle} - Photos` },
      {
        property: 'og:url',
        content: `${process.env.BASE_URL}/movies/${params.movieId}/photos`,
      },
      { property: 'og:title', content: `Bisanonton - ${movieTitle} - Photos` },
      { name: 'twitter:title', content: `Bisanonton - ${movieTitle} - Photos` },
    ];
  },
);
