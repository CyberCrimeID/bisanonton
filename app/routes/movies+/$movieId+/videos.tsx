...
export const meta = mergeMeta<typeof loader, { 'routes/movies+/$movieId': typeof movieIdLoader }>(
  ({ params, matches }) => {
    ...
    return [
      { title: `Bisanonton - ${movieTitle} - Videos` },
      {
        property: 'og:url',
        content: `${process.env.BASE_URL}/movies/${params.movieId}/videos`,
      },
      { property: 'og:title', content: `Bisanonton - ${movieTitle} - Videos` },
      { name: 'twitter:title', content: `Bisanonton - ${movieTitle} - Videos` },
    ];
  },
);
