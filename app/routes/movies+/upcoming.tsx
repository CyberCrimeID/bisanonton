...
export const meta = mergeMeta(() => [
  { title: 'Bisanonton - Upcoming Movies' },
  { name: 'description', content: 'Upcoming Movies' },
  { property: 'og:url', content: `${process.env.BASE_URL}/movies/upcoming` },
  { property: 'og:title', content: 'Bisanonton - Upcoming Movies' },
  { property: 'og:description', content: 'Upcoming Movies' },
  { name: 'twitter:title', content: 'Bisanonton - Upcoming Movies' },
