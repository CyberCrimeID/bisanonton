...
export const meta = mergeMeta(({ params }) => {
  ...
  return [
    { title: `Bisanonton - Trending ${mediaType} today` },
    {
      name: 'keywords',
      content: `trending, trending ${mediaType}, trending today, trending ${mediaType} today`,
    },
    { property: 'og:url', content: `${process.env.BASE_URL}/trending/${mediaType}/today` },
    { property: 'og:title', content: `Bisanonton - Trending ${mediaType} today` },
    { name: 'description', content: `Trending ${mediaType} today` },
    { property: 'og:description', content: `Trending ${mediaType} today` },
    { name: 'twitter:title', content: `Bisanonton - Trending ${mediaType} today` },
