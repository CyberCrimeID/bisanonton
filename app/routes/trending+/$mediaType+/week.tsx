...
export const meta = mergeMeta(({ params }) => {
  ...
  return [
    { title: `Bisanonton - Trending ${mediaType} This Week` },
    {
      name: 'keywords',
      content: `trending, trending ${mediaType}, trending this week, trending ${mediaType} this week`,
    },
    { property: 'og:url', content: `${process.env.BASE_URL}/trending/${mediaType}/week` },
    { property: 'og:title', content: `Bisanonton - Trending ${mediaType} This Week` },
    { name: 'description', content: `Trending ${mediaType} This Week` },
    { property: 'og:description', content: `Trending ${mediaType} This Week` },
    { name: 'twitter:title', content: `Bisanonton - Trending ${mediaType} This Week` },
