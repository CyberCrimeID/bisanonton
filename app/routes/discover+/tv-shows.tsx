...
export const meta = mergeMeta(() => [
  { title: 'Bisanonton - Discover tv shows' },
  { name: 'description', content: 'Discover tv shows on Bisanonton' },
  { property: 'og:url', content: `${process.env.BASE_URL}/discover/tv-shows` },
  { property: 'og:title', content: 'Bisanonton - Discover tv shows' },
  { property: 'og:image', content: `${process.env.BASE_URL}/api/ogimage?it=tvshows` },
  { property: 'og:description', content: 'Discover tv shows on Bisanonton' },
  { name: 'twitter:title', content: 'Bisanonton - Discover tv shows' },
  { name: 'twitter:description', content: 'Discover tv shows on Bisanonton' },
  { name: 'twitter:image', content: `${process.env.BASE_URL}/api/ogimage?it=tvshows` },
]);
