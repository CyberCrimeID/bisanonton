...
export const meta = mergeMeta(() => [
  { title: 'Bisanonton - Discover movies' },
  { name: 'description', content: 'Discover Movies on Bisanonton' },
  { property: 'og:url', content: `${process.env.BASE_URL}/discover/movies` },
  { property: 'og:title', content: 'Bisanonton - Discover movies' },
  { property: 'og:image', content: `${process.env.BASE_URL}/api/ogimage?it=movies` },
  { property: 'og:description', content: 'Discover Movies on Bisanonton' },
  { name: 'twitter:title', content: 'Bisanonton - Discover movies' },
  { name: 'twitter:description', content: 'Discover Movies on Bisanonton' },
  { name: 'twitter:image', content: `${process.env.BASE_URL}/api/ogimage?it=movies` },
]);
