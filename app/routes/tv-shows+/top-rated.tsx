...
export const meta = mergeMeta(() => [
  { title: 'Bisanonton - Top Rated Tv Shows' },
  { name: 'description', content: 'Top Rated Tv Shows' },
  { property: 'og:url', content: `${process.env.BASE_URL}/tv-shows/top-rated` },
  { property: 'og:title', content: 'Bisanonton - Top Rated Tv Shows' },
  { property: 'og:description', content: 'Top Rated Tv Shows' },
  { name: 'twitter:title', content: 'Bisanonton - Top Rated Tv Shows' },
