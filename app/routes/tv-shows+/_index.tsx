...
export const meta = mergeMeta(() => [
  { title: 'Bisanonton - Tv Shows' },
  { name: 'description', content: 'Discover tv shows in Bisanonton' },
  { property: 'og:url', content: `${process.env.BASE_URL}/tv-shows/` },
  { property: 'og:title', content: 'Bisanonton - Tv Shows' },
  { property: 'og:description', content: 'Discover tv shows in Bisanonton' },
  { name: 'twitter:title', content: 'Bisanonton - Tv Shows' },
  { name: 'twitter:description', content: 'Discover tv shows in Bisanonton' },
]);
