...
export const meta = mergeMeta(() => [
  { title: 'Bisanonton - Popular People' },
  { name: 'description', content: 'Discover the most popular celebrities on Bisanonton.' },
  {
    name: 'keywords',
    content:
  ...
  { property: 'og:url', content: `${process.env.BASE_URL}/people` },
  { property: 'og:title', content: 'Bisanonton - Popular People' },
  { property: 'og:image', content: `${process.env.BASE_URL}/api/ogimage?it=people` },
  { property: 'og:description', content: 'Discover the most popular celebrities on Bisanonton.' },
  { name: 'twitter:title', content: 'Bisanonton - Popular People' },
  { name: 'twitter:description', content: 'Discover the most popular celebrities on Bisanonton.' },
  { name: 'twitter:image', content: `${process.env.BASE_URL}/api/ogimage?it=people` },
]);
