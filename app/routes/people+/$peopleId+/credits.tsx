...
export const meta = mergeMeta<null, { 'routes/people+/$peopleId': typeof peopleIdLoader }>(
  ({ params, matches }) => {
    ...
    return [
      { title: `Bisanonton - ${peopleTitle} - Credits` },
      {
        property: 'og:url',
        content: `${process.env.BASE_URL}/people/${params.peopleId}/credits`,
      },
      { property: 'og:title', content: `Bisanonton - ${peopleTitle} - Credits` },
      { name: 'twitter:title', content: `Bisanonton - ${peopleTitle} - Credits` },
    ];
  },
);
