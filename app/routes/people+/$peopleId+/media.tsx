...
export const meta = mergeMeta<null, { 'routes/people+/$peopleId': typeof peopleIdLoader }>(
  ({ params, matches }) => {
    ...
    return [
      { title: `Bisanonton - ${peopleTitle} - Media` },
      {
        property: 'og:url',
        content: `${process.env.BASE_URL}/people/${params.peopleId}/media`,
      },
      { property: 'og:title', content: `Bisanonton - ${peopleTitle} - Media` },
      { name: 'twitter:title', content: `Bisanonton - ${peopleTitle} - Media` },
    ];
  },
);
