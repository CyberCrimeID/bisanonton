...
export const meta = mergeMeta<null, { 'routes/people+/$peopleId': typeof peopleIdLoader }>(
  ({ params, matches }) => {
    ...
    return [
      { title: `Bisanonton - ${peopleTitle}` },
      {
        property: 'og:url',
        content: `${process.env.BASE_URL}/people/${params.peopleId}/`,
      },
      { property: 'og:title', content: `Bisanonton - ${peopleTitle}` },
      { name: 'twitter:title', content: `Bisanonton - ${peopleTitle}` },
    ];
  },
);
