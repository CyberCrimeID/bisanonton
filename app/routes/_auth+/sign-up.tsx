...
export const meta = mergeMeta(() => [
  { title: 'Bisanonton - Sign Up' },
  { name: 'description', content: 'Sign up for a Bisanonton account.' },
  { property: 'og:title', content: 'Bisanonton - Sign Up' },
  { property: 'og:description', content: 'Sign up for a Bisanonton account.' },
  { property: 'og:url', content: `${process.env.BASE_URL}/sign-up` },
  { property: 'twitter:title', content: 'Bisanonton - Sign Up' },
  { property: 'twitter:description', content: 'Sign up for a Bisanonton account.' },
]);
...
export const action = async ({ request }: ActionFunctionArgs) => {
  ...
  return redirectWithToast(
    ...
    ref,
    {
      type: 'success',
      title: 'Sign Up Successfully',
      description: 'Welcome to Bisanonton!',
    },
