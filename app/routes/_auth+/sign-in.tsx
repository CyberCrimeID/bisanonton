...
export const meta = mergeMeta(() => [
  { title: 'Bisanonton - Sign In' },
  { name: 'description', content: 'Sign in to your Bisanonton account.' },
  { property: 'og:title', content: 'Bisanonton - Sign In' },
  { property: 'og:description', content: 'Sign in to your Bisanonton account.' },
  { property: 'og:url', content: `${process.env.BASE_URL}/sign-in` },
  { property: 'twitter:title', content: 'Bisanonton - Sign In' },
  { property: 'twitter:description', content: 'Sign in to your Bisanonton account.' },
]);
