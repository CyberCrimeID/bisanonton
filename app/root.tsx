...
export const meta: MetaFunction<typeof loader> = () => [
  { title: 'Bisanonton' },
  { name: 'description', content: 'Watching movies, series, anime and more in Bisanonton' },
  {
    name: 'keywords',
    content:
      'Bisanonton, Bisanonton Movies, Bisanonton Series, Bisanonton Anime, watch movies, watch series, watch anime, watch movies online, watch series online, watch anime online, free movies, free series, free anime, free movies online, free series online, free anime online, watch movies free, watch series free, watch anime free, watch movies online free, watch series online free, watch anime online free',
  },
  { property: 'og:url', content: process.env.BASE_URL },
  { property: 'og:title', content: 'Bisa Nonton' },
  { property: 'og:image', content: `${process.env.BASE_URL}/api/ogimage?it=home` },
  { property: 'og:description', content: 'Watching movies, series, anime and more in Bisanonton' },
  { property: 'og:type', content: 'website' },
  { property: 'og:site_name', content: 'Bisa Nonton' },
  { property: 'og:image:width', content: '1200' },
  { property: 'og:image:height', content: '630' },
  { name: 'twitter:card', content: 'summary_large_image' },
  { name: 'twitter:site', content: '@bisanonton' },
  { name: 'twitter:image', content: `${process.env.BASE_URL}/api/ogimage?it=home` },
  { name: 'twitter:title', content: 'Bisanonton' },
  { name: 'twitter:description', content: 'Watching movies, series, anime and more in Bisanonton' },
];
  ...
  React.useEffect(() => {
    ...
    if (isUpdateAvailable) {
      toast.success('Update Available', {
        description: 'A new version of Bisanonton is available.',
        action: {
          label: 'Update',
          onClick: () => reloadPage(),
        },
